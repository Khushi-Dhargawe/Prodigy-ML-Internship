...
Five tasks. Five algorithms. Five complete pipelines — this internship covers the full breadth of ML paradigms expected in a junior data analyst or ML engineer role, from tabular regression to deep learning on image data.
...
|---|---|---|---|---|
| 01 | House Price Prediction | Linear Regression | KC Housing (21,613 rows) | R² = 0.51, sqft_living coeff = +144,528 |
| 02 | Customer Segmentation | K-Means (k=5) | Mall Customers (200 rows) | Silhouette = 0.4166, 5 segments profiled |
| 03 | Cats vs Dogs Classifier | SVM + PCA | Kaggle Dogs vs Cats | PCA: 150 components, ~85% variance retained |
| 04 | Hand Gesture Recognition | CNN (3 conv blocks) | LeapGestRecog (Kaggle) | Val Accuracy 95%+, 10 gesture classes |
| 05 | US Accident EDA | EDA + Visualisation | US Accidents 2016–2020 (2.9M rows) | 7 insights, 7 charts, rush hour patterns |
...
**Cluster Profiles:**
| Cluster | Avg Income | Avg Spending Score | Segment |
|---|---|---|---|
| 0 | $26.8k | 18.4 | Budget Shoppers |
| 1 | $41.1k | 62.2 | Standard Customers |
| 2 | $86.1k | 81.5 | Premium Targets ← Priority |
| 3 | $86.1k | 19.4 | Careful Savers |
| 4 | $54.4k | 48.9 | Middle Ground |
...
For Task 1, I'd add polynomial features and try Ridge/Lasso regularisation to handle the multicollinearity between sqft_living and sqft_above. 
For Task 3, I'd replace the SVM with a fine-tuned ResNet50 — the accuracy ceiling with SVM+PCA on 64×64 images is limited. 
For Task 5, I'd build an interactive Plotly dashboard instead of static charts.
